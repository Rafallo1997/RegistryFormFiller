...
public class FormFiller {
     ...
     */
     void input(WebElement element,String input){
     ...
     * @param id String Id of WebElement
     * @param input String to be inputted
     */
...
WebElement element=driver.findElement(By.id(id));
     ...
     void select_by_text(String id,String text){
     ...
     */
     void Birthday_form(int day,int month,int year){
     ...
     */
     void Title_selector(String title){
switch (title){
    case "Mr":
